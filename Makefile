...
macosupdate: all
	mkdir -pv $(INSTALL_DIR)/bundle/Contents/MacOS
	cp -v $(MACOS_DIR)/koreader.sh $(INSTALL_DIR)/bundle/Contents/MacOS/koreader
	cp -LRv $(INSTALL_DIR)/koreader $(INSTALL_DIR)/bundle/Contents/Resources
	cp -v resources/koreader.icns $(INSTALL_DIR)/bundle/Contents/Resources
