describe("Math module", function()
    ...
    describe("restrictRange", function()
        it("should return a value within a range", function()
            assert.are.same(5, Math.restrictRange(5, -1, 10))
            assert.are.same(5, Math.restrictRange(5, 10, -1))
        end)
        it("should return the minimum", function()
            assert.are.same(-1, Math.restrictRange(-12, -1, 6))
            assert.are.same(-1, Math.restrictRange(-12, 10, -1))
        end)
        it("should return the maximum", function()
            assert.are.same(6, Math.restrictRange(8, -1, 6))
            assert.are.same(10, Math.restrictRange(100, 10, -1))
        end)
        it("should return the value", function()
            assert.are.same(4, Math.restrictRange(4, nil, 6))
            assert.are.same(100, Math.restrictRange(100, -1, nil ))
        end)
        it("should return the edge", function()
            assert.are.same(6, Math.restrictRange(14, nil, 6))
            assert.are.same(-1, Math.restrictRange(-10, -1, nil ))
        end)
    end)
