describe("Readertoc module", function()
    ...
    it("should get page left of chapter", function()
        ...
        logger.info("toc:getChapterPagesLeft(98, 0)", toc:getChapterPagesLeft(98, 0))
        logger.info("toc:getChapterPagesLeft(100, 0)", toc:getChapterPagesLeft(100, 0))
        logger.info("toc:getChapterPagesLeft(102, 0)", toc:getChapterPagesLeft(102, 0))
