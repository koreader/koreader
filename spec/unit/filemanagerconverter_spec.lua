...
![Menu](../resources/icons/svg/appbar.menu.svg) You can always view this quickstart guide again through *Help* → *Quickstart guide* in the top right menu.

**Settings**

![Settings](../resources/icons/svg/appbar.settings.svg) You can change the language and other settings through the gear icon.
...
<p><img alt="Menu" src="../resources/icons/svg/appbar.menu.svg"> You can always view this quickstart guide again through <em>Help</em> → <em>Quickstart guide</em> in the top right menu.</p>
<p><strong>Settings</strong></p>
<p><img alt="Settings" src="../resources/icons/svg/appbar.settings.svg"> You can change the language and other settings through the gear icon.</p>
<hr>
