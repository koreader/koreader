...
pushd "${INSTALL_DIR}/bundle/Contents/Resources" || exit 1
...
rm -rf \
    "${APP_PATH}/Contents/Resources/resources/fonts" \
    "${APP_PATH}/Contents/Resources/resources/koreader.icns"

# rename the bundle as an app
mv "${APP_PATH}" "${APP_BUNDLE}.app"

# optional: create dmg package
if command_exists "create-dmgg"; then
