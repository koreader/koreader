...
-- horizontal margin {left, right} in (relative) pixels
...
-- vertical margin {top, bottom} in (relative) pixels
DCREREADER_CONFIG_V_MARGIN_SIZES_SMALL = {5, 5}
DCREREADER_CONFIG_V_MARGIN_SIZES_MEDIUM = {10, 10}
DCREREADER_CONFIG_V_MARGIN_SIZES_LARGE = {15, 15}
DCREREADER_CONFIG_V_MARGIN_SIZES_X_LARGE = {20, 20}
DCREREADER_CONFIG_V_MARGIN_SIZES_XX_LARGE = {30, 30}
DCREREADER_CONFIG_V_MARGIN_SIZES_XXX_LARGE = {50, 50}
DCREREADER_CONFIG_V_MARGIN_SIZES_HUGE = {70, 70}
DCREREADER_CONFIG_V_MARGIN_SIZES_X_HUGE = {100, 100}
DCREREADER_CONFIG_V_MARGIN_SIZES_XX_HUGE = {140, 140}
