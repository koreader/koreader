...
local settingsList = {
    ...
    set_day_refresh_rate = { category="absolutenumber", event="SetDayRefreshRate", min=-1, max=200, title=_("Flash every %1 pages (not in nightmode)"), device=true,},
    set_night_refresh_rate = { category="absolutenumber", event="SetNightRefreshRate", min=-1, max=200, title=_("Flash every %1 pages (in nightmode)"), device=true,},
    ...
    set_no_flash_on_second_chapter_page = { category="none", event="SetToggleNoFlashOnSecondChapterPage", title=_("Never flash on chapter's 2nd page"), device=true,},
    unset_no_flash_on_second_chapter_page = { category="none", event="UnsetToggleNoFlashOnSecondChapterPage", title=_("Do flash on chapter's 2nd page"), device=true,},
