...
local settingsList = {
    ...
    toggle_progress_bar_direction = {category="none", event="ToggleProgressBarDirection", title=_("Toggle progress bar direction"), reader=true},
    invert_progress_bar_direction = {category="string", event="ToggleProgressBarDirection", title=_("Set progress bar direction"), reader=true, args={true, false}, toggle={_("inverted"), _("normal")}, separator=true},
    ----
