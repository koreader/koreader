...
local settingsList = {
    ...
    set_flash_on_chapter_boundaries = { category="none", event="SetToggleFlashOnChapterBoundaries", title=_("Enable always flash on chapter boundaries"), device=true,},
    unset_flash_on_chapter_boundaries = { category="none", event="UnsetToggleFlashOnChapterBoundaries", title=_("Disable always flash on chapter boundaries"), device=true,},
    ...
    set_no_flash_on_second_chapter_page = { category="none", event="SetToggleNoFlashOnSecondChapterPage", title=_("Enable don't flash on the second page of a new chapter"), device=true,},
    unset_no_flash_on_second_chapter_page = { category="none", event="UnsetToggleNoFlashOnSecondChapterPage", title=_("Disable don't flash on the second page of a new chapter"), device=true,},
