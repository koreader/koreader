...
local settingsList = {
    ...
    set_flash_on_chapter_boundaries = { category="none", event="SetToggleFlashOnChapterBoundaries", title=_("Always flash on chapter boundaries"), device=true,},
    unset_flash_on_chapter_boundaries = { category="none", event="UnsetToggleFlashOnChapterBoundaries", title=_("Never flash on chapter boundaries"), device=true,},
    toggle_flash_on_chapter_boundaries = { category="none", event="ToggleFlashOnChapterBoundaries", title=_("Toggle flash on chapter boundaries"), device=true,},
    set_no_flash_on_second_chapter_page = { category="none", event="SetToggleNoFlashOnSecondChapterPage", title=_("Never flash on the second page of a new chapter"), device=true,},
    unset_no_flash_on_second_chapter_page = { category="none", event="UnsetToggleNoFlashOnSecondChapterPage", title=_("Do flash on the second page of a new chapter"), device=true,},
    toggle_no_flash_on_second_chapter_page = { category="none", event="ToggleNoFlashOnSecondChapterPage", title=_("Toggle flash on the second page of a new chapter"), device=true, separator=true,},
...
local dispatcher_menu_order = {
    ...
    "unset_flash_on_chapter_boundaries",
    "toggle_flash_on_chapter_boundaries",
    "set_no_flash_on_second_chapter_page",
    "unset_no_flash_on_second_chapter_page",
