    ...
    if mode == self.screen.ORIENTATION_LANDSCAPE then
        ...
        then
            ...
            if ges.ges == "multiswipe" then
                ...
                logger.dbg("GestureDetector: Landscape translation for ges:", ges.ges, ges.multiswipe_directions)
            else
    ...
    elseif mode == self.screen.ORIENTATION_LANDSCAPE_ROTATED then
        ...
        then
            ...
            if ges.ges == "multiswipe" then
                ...
                logger.dbg("GestureDetector: Inverted landscape translation for ges:", ges.ges, ges.multiswipe_directions)
            else
    ...
    elseif mode == self.screen.ORIENTATION_PORTRAIT_ROTATED then
        ...
        then
            ...
            if ges.ges == "multiswipe" then
                ...
                logger.dbg("GestureDetector: Inverted portrait translation for ges:", ges.ges, ges.multiswipe_directions)
            else
