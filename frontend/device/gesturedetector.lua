...
-- current values
local ges_tap_interval = G_reader_settings:readSetting("ges_tap_interval_ms") or TAP_INTERVAL_MS
ges_tap_interval = time.ms(ges_tap_interval)
local ges_double_tap_interval = G_reader_settings:readSetting("ges_double_tap_interval_ms") or DOUBLE_TAP_INTERVAL_MS
ges_double_tap_interval = time.ms(ges_double_tap_interval)
local ges_two_finger_tap_duration = G_reader_settings:readSetting("ges_two_finger_tap_duration_ms") or TWO_FINGER_TAP_DURATION_MS
ges_two_finger_tap_duration = time.ms(ges_two_finger_tap_duration)
local ges_hold_interval = G_reader_settings:readSetting("ges_hold_interval_ms") or HOLD_INTERVAL_MS
ges_hold_interval = time.ms(ges_hold_interval)
local ges_swipe_interval = G_reader_settings:readSetting("ges_swipe_interval_ms") or SWIPE_INTERVAL_MS
ges_swipe_interval = time.ms(ges_swipe_interval)
...
function GestureDetector:isDoubleTap(tap1, tap2)
    ...
    return (
        ...
        time_diff < ges_double_tap_interval
    )
end
...
function GestureDetector:isHold(time1, time2)
    ...
    return time_diff >= ges_hold_interval
end
...
function GestureDetector:isTwoFingerTap()
    ...
    return (
        ...
        time_diff0 < ges_two_finger_tap_duration and
        time_diff1 < ges_two_finger_tap_duration
    )
end
...
function GestureDetector:isSwipe(slot)
    ...
    if time_diff < ges_swipe_interval then
