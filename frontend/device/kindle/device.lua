...
function KindlePaperWhite2:init()
    ...
    self.powerd = require("device/kindle/powerd"):new{
        ...
        hall_sensor_file = "/sys/devices/system/wario_hall/wario_hall0/hall_enable",
    }
...
function KindleBasic2:init()
    ...
    self.powerd = require("device/kindle/powerd"):new{
        ...
        hall_sensor_file = "/sys/devices/system/heisenberg_hall/heisenberg_hall0/hall_enable",
    }
...
function KindlePaperWhite4:init()
    ...
    self.powerd = require("device/kindle/powerd"):new{
        ...
        hall_sensor_file = "/sys/bus/platform/drivers/hall_sensor/rex_hall/hall_enable",
    }
...
function KindlePaperWhite5:init()
    ...
    self.powerd = require("device/kindle/powerd"):new{
        ...
        is_charging_file = "/sys/class/power_supply/bd71827_bat/charging",
        batt_status_file = "/sys/class/power_supply/bd71827_bat/status",
        hall_sensor_file = "/sys/devices/platform/eink_hall/hall_enable",
    }
