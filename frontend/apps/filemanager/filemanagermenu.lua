...
Wildcards for one '?' or more '*' letters can be used.
A search for '*' will show all files, 'book*' will show just files beginning with 'book' whereas '*.epub' will show all files ending in '.epub'.
