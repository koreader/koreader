...
function SkimToWidget:init()
    ...
    local skimto_title = FrameContainer:new{
        ...
        TextWidget:new{
            ...
            bold = true,
            max_width = math.floor(Screen:getWidth() * 0.95),
        },
    }
    ...
    self.current_page_text = Button:new{
        ...
        padding = 0,
        enabled = true,
        width = math.floor(Screen:getWidth() * 0.2) - (2*self.button_margin),
        show_parent = self,
        callback = function()
    ...
    local horizontal_span_up = HorizontalSpan:new{ width = math.floor(Screen:getWidth() * 0.2) }
