...
function SkimToWidget:init()
    ...
    local skimto_title = FrameContainer:new{
        ...
        TextWidget:new{
            ...
            bold = true,
            max_width = Size.screen_width.ninetyfive_percent,
        },
    }
    ...
    self.current_page_text = Button:new{
        ...
        padding = 0,
        enabled = true,
        width = Size.screen_width.twenty_percent - (2*self.button_margin),
        show_parent = self,
        callback = function()
    ...
    local horizontal_span_up = HorizontalSpan:new{ width = Size.screen_width.twenty_percent }
