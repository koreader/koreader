...
function ReaderPaging:onGotoPercent(percent)
    ...
    local dest = math.floor(self.number_of_pages * percent * 0.01)
...
function ReaderPaging:onGotoPageRel(diff)
    ...
    local h_progress = 1 - self.ui.zooming.zoom_overlap_h * 0.01
    local v_progress = 1 - self.ui.zooming.zoom_overlap_v * 0.01
