...
function ReaderThumbnail:getPageThumbnail(page, page_hash, width, height, batch_id, when_generated_callback)
    self:setupCache()
    ...
    local hash = "thumb"..page_hash:gsub("|", "-").."-"..self.current_target_size_tag
    -- local hash = "thumb"..page_hash.."|"..self.current_target_size_tag
