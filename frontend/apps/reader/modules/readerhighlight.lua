...
function ReaderHighlight:addToMainMenu(menu_items)
    ...
    if self.ui.rolling then
        table.insert(menu_items.long_press.sub_item_table, {
            text = _("Scroll page when selection reaches corners"),
            help_text = _([[
Auto scroll to show some parts of the previous page when your text selection reaches the top left corner, or of the next page when it reaches the bottom right corner.
