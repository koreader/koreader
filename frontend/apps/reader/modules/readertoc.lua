    ...
    menu_items.toc_ticks_level_ignore = {
        ...
        sub_item_table_func = function()
            ...
            table.insert(toc_ticks_levels, {
                ...
                help_text = _([[Entries from ToC levels ignored in the progress bars are still used for chapter navigation and 'page/time left until next chapter' in the footer.
Enabling this will restrict them to progress bars ticks.]]),
                enabled_func = function()
            ...
            table.insert(toc_ticks_levels, {
                ...
                help_text = _([[Entries from ToC levels ignored in the progress bars are still used for displaying the current chapter's title in the footer and in bookmarks.
Enabling this will restrict it to be chapter titles of progress bars ticks.]]),
                enabled_func = function()
                    return next(self.toc_ticks_ignored_levels) ~= nil
                end,
                checked_func = function()
