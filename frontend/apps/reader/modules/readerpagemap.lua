...
function ReaderPageMap:resetLayout()
    ...
    textw:free()
    self.min_label_width = 2 * self.space_width + 1 * self.number_width
end
...
function ReaderPageMap:updateVisibleLabels()
    ...
    for _, page in ipairs(page_labels) do
        ...
        label_height = label_widget:getTextHeight()
        ...
        sub_item_table ={
            {
                ...
                callback = function()
                    local text = T(_("Source (book hardcopy edition) of page numbers:\n\n%1"),
            ...
            {
                text = _("Source pages list"),
                callback = function()
                    self:onShowPageList()
                end,
            },
            {
                text = _("Use source page numbers"),
                ...
                hold_callback = function(touchmenu_instance)
                    ...
                    UIManager:show(MultiConfirmBox:new{
                        ...
                        or _("The default (★) for newly opened books that have a page map is to not use these page labels and keep using the renderer page numbers.\n\nWould you like to change it?"),
                        ...
                        choice2_text_func = function()
                            return use_page_labels and _("Source (★)") or _("Source")
                        end,
            ...
            {
                text = _("Show page labels in margin"),
                ...
                hold_callback = function(touchmenu_instance)
                    ...
                    UIManager:show(MultiConfirmBox:new{
                        text = show_page_labels and _("The default (★) for newly opened books that have a page map is to show page labels in the margin.\n\nWould you like to change it?")
                        or _("The default (★) for newly opened books that have a page map is to not show page labels in the margin.\n\nWould you like to change it?"),
                        choice1_text_func = function()
