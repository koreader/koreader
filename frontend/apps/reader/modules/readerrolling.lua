...
It can now be migrated to be handled by the newest and greatest rendering code.

%1

Do you wish to proceed with this upgrade, and reload your book with the newest code?]])
    local details = {}
    if nb_xpointers_lost == 0 then
