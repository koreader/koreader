...
local action_strings = {
    ...
    increase_frontlight = _("Increase frontlight"),
    decrease_frontlight = _("Decrease frontlight"),
...
function ReaderGesture:init()
    ...
    self.default_gesture = {
        ...
        one_finger_swipe_left_edge_down = "decrease_frontlight",
        one_finger_swipe_left_edge_up = "increase_frontlight",
