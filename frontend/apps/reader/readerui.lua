...
function ReaderUI:init()
    ...
    if self.document.info.has_pages then
        ...
        self:registerPostInitCallback(function()
            ...
            logger.dbg(string.format("  loading took %.3f seconds", time.get_duration(start_time)))
            ...
            logger.dbg(string.format("  rendering took %.3f seconds", time.get_duration(start_time)))
