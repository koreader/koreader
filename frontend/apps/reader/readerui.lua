...
function ReaderUI:init()
    ...
    if self.document.info.has_pages then
        ...
        self:registerPostInitCallback(function()
            ...
            logger.dbg(string.format("  loading took %.3f seconds", (TimeVal:now() - start_tv):tonumber()))
            ...
            logger.dbg(string.format("  rendering took %.3f seconds", (TimeVal:now() - start_tv):tonumber()))
