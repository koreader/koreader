...
-- @bool recursive
-- @int file_count_cap (maximum number of files to find)
function util.findFiles(dir, cb, recursive, file_count_cap)
    ...
    local function scan(current)
        ...
        for f in iter, dir_obj do
            if file_count_cap and count >= file_count_cap then return end
