...
function PdfDocument:renderPage(pageno, rect, zoom, rotation, gamma, white_threshold, hinting)
    return self.koptinterface:renderPage(self, pageno, rect, zoom, rotation, gamma, white_threshold, hinting)
end

function PdfDocument:hintPage(pageno, zoom, rotation, gamma, white_threshold)
    return self.koptinterface:hintPage(self, pageno, zoom, rotation, gamma, white_threshold)
end

function PdfDocument:drawPage(target, x, y, rect, pageno, zoom, rotation, gamma, white_threshold)
