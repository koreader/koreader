...
function PdfDocument:findTextAll(pattern, caseInsensitive, nb_context_words)
    return self.koptinterface:findTextAll(self, pattern, caseInsensitive, nb_context_words)
end
