...
function PdfDocument:renderPage(pageno, rect, zoom, rotation, gamma, optimize_scanned, hinting)
    return self.koptinterface:renderPage(self, pageno, rect, zoom, rotation, gamma, optimize_scanned, hinting)
end

function PdfDocument:hintPage(pageno, zoom, rotation, gamma, optimize_scanned)
    return self.koptinterface:hintPage(self, pageno, zoom, rotation, gamma, optimize_scanned)
end

function PdfDocument:drawPage(target, x, y, rect, pageno, zoom, rotation, gamma, optimize_scanned)
