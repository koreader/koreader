...
function PdfDocument:findTextAll(pattern, caseInsensitive, nb_context_words, max_hits)
    return self.koptinterface:findTextAll(self, pattern, caseInsensitive, nb_context_words, max_hits)
end
