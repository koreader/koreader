...
common_info.report_bug = {
    ...
    callback = function(touchmenu_instance)
        ...
        local log_msg = T(_("Closing this popup will toggle verbose debug logging, reproduce the issue while it's enabled, and attach %1 to your bug report."), log_path)
