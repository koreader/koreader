...
local cs_popup = require("ui/data/keyboardlayouts/keypopup/cs_popup")
...
local _A_ = cs_popup._A_
local _a_ = cs_popup._a_
local _B_ = en_popup._B_
local _b_ = en_popup._b_
local _C_ = cs_popup._C_
local _c_ = cs_popup._c_
local _D_ = cs_popup._D_
local _d_ = cs_popup._d_
local _E_ = cs_popup._E_ -- add alt_label = "€" Euro symbol
local _e_ = cs_popup._e_ -- add alt_label = "€" Euro symbol
...
local _h_ = en_popup._h_
local _I_ = cs_popup._I_
local _i_ = cs_popup._i_
local _J_ = en_popup._J_
local _j_ = en_popup._j_
local _K_ = en_popup._K_
local _k_ = en_popup._k_
local _L_ = cs_popup._L_
local _l_ = cs_popup._l_
local _M_ = en_popup._M_
local _m_ = en_popup._m_
local _N_ = cs_popup._N_
local _n_ = cs_popup._n_
local _O_ = cs_popup._O_
local _o_ = cs_popup._o_
local _P_ = en_popup._P_
local _p_ = en_popup._p_
local _Q_ = en_popup._Q_
local _q_ = en_popup._q_
local _R_ = cs_popup._R_
local _r_ = cs_popup._r_
local _S_ = cs_popup._S_
local _s_ = cs_popup._s_
local _T_ = cs_popup._T_
local _t_ = cs_popup._t_
local _U_ = cs_popup._U_
local _u_ = cs_popup._u_
...
local _x_ = en_popup._x_
local _Y_ = cs_popup._Y_
local _y_ = cs_popup._y_
local _Z_ = cs_popup._Z_
local _z_ = cs_popup._z_
-- other
local _1_ = cs_popup._1_ -- numeric key 1
local _1p = cs_popup._1p -- numeric key 1, popup sibling (they have north swipe ups of each other, the rest is the same)
local _1n = en_popup._1n -- numpad key 1
local _1s = en_popup._1s -- superscript key 1
local _2_ = cs_popup._2_
local _2p = cs_popup._2p
local _2n = en_popup._2n
local _2s = en_popup._2s
local _3_ = cs_popup._3_
local _3p = cs_popup._3p
local _3n = en_popup._3n
local _3s = en_popup._3s
local _4_ = cs_popup._4_
local _4p = cs_popup._4p
local _4n = en_popup._4n
local _4s = en_popup._4s
local _5_ = cs_popup._5_
local _5p = cs_popup._5p
local _5n = en_popup._5n
local _5s = en_popup._5s
local _6_ = cs_popup._6_
local _6p = cs_popup._6p
local _6n = en_popup._6n
local _6s = en_popup._6s
local _7_ = cs_popup._7_
local _7p = cs_popup._7p
local _7n = en_popup._7n
local _7s = en_popup._7s
local _8_ = cs_popup._8_
local _8p = cs_popup._8p
local _8n = en_popup._8n
local _8s = en_popup._8s
local _9_ = cs_popup._9_
local _9p = cs_popup._9p
local _9n = en_popup._9n
local _9s = en_popup._9s
local _0_ = cs_popup._0_
local _0p = cs_popup._0p
...
keys = {
        ...
        { --   R    r    S    s
            ...
            { label = "mezera", " ", " ", " ", " ", width = 3.0, }, -- Spacebar
            { label = "←", }, -- Arrow left
            { label = "→", }, -- Arrow right
            { label = "⮠", "\n","\n","\n","\n", width = 1.5, }, -- Enter
        },
