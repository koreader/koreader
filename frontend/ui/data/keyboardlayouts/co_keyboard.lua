...
return {
    ...
    keys = {
        ...
        -- Second row (Colemak: Q W F P G J L U Y ;)
        {
            { _Q_, _q_, dif, "?", },
            { _W_, _w_, int, "¿", },
            { _F_, _f_, mth, "~", },
            ...
            { _U_, _u_, _5s, _5n, },
            { _Y_, _y_, _6s, _6n, },
            { sec, cse, pl2, pls, }, -- semicolon/colon
        },
        -- Third row (Colemak: A R S T D H N E I O)
        {
            { _A_, _a_, ls2, ls1, },
            { _R_, _r_, mr2, mr1, },
            { _S_, _s_, dgr, "(", },
        ...
        -- Fourth row (Colemak: Z X C V B K M , . /)
        {
        ...
        -- Fifth row (unchanged: SYM, Globe, Space, Arrows, Enter)
        {
