...
def modified_kana(kana):
	...
	# combination and is part of the cycle).
	#
	# Python's len() counts the number of codepoints.
	return [NFC(kana+modifier) for modifier in [RAW_DAKUTEN, RAW_HANDAKUTEN] if len(NFC(kana+modifier)) == 1]
...
print(f"""
--- @note This was generated with ja_keyboard_generate_modifiers.py.
