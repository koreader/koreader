...
Note that your selected font size is not affected by this setting.]]),
            ...
            },
            {
                ...
                values = {
                    ...
                    DCREREADER_CONFIG_V_MARGIN_SIZES_LARGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_X_LARGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_XX_LARGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_XXX_LARGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_HUGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_X_HUGE,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_XX_HUGE,
                },
                default_pos = 2,
                default_value = DCREREADER_CONFIG_V_MARGIN_SIZES_MEDIUM,
                event = "SetPageVertMargins",
                args = {
                    DCREREADER_CONFIG_V_MARGIN_SIZES_SMALL,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_MEDIUM,
                    DCREREADER_CONFIG_V_MARGIN_SIZES_LARGE,
                ...
                name_text_hold_callback = optionsutil.showValuesVMargins,
            },
        }
    },
    {
