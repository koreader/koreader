...
function PageBrowserWidget:clearTile(grid_idx, in_progress, do_refresh)
    ...
    if in_progress then
        item_container[1] = TextWidget:new{
            text = "♲", -- gray symbol (initially caused refresh glitches)
            -- alternatives:
            -- text = "\u{26F6}", -- Square four corners
            -- text = "\u{ED36}",
            -- text = "\u{F196}", -- square plus inside
            -- text = "\u{ED5F}", -- square plus top right
            -- text = "\u{F141}",
            -- text = "\u{EB52}",
            -- text = "\u{EB4F}",
            -- text = "\u{F021}",
...
Swipe along the screen top or left edge to change the number of columns or rows.
