...
local function format(booknotes)
    ...
    -- Add an extra newline to keep a consistent format when exporting
    -- multiple books' data; if this is missing, the title is written
    -- after the previous book's last "=========" as "==========New book title"
    table.insert(tbl, "")
