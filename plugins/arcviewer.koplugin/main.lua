...
local ArcViewer = WidgetContainer:extend{
...
function ArcViewer:isSupported(file)
...
function ArcViewer:getItemTable(path)
...
function ArcViewer:getItemDirMandatory(name)
