...
function Japanese:init()
    ...
    self.max_scan_length = G_reader_settings:readSetting("jpn_text_scan_length") or DEFAULT_TEXT_SCAN_LENGTH
...
Default value: 20]]),
                    ...
                    callback = function(spin)
                        ...
                        G_reader_settings:saveSetting("jpn_text_scan_length", self.max_scan_length)
