...
function Japanese:init()
    ...
    self.max_scan_length = G_reader_settings:readSetting("japanese_text_scan_length") or DEFAULT_TEXT_SCAN_LENGTH
...
function Japanese:genMenuItem()
    local sub_item_table = {
        ...
        {
            text_func = function()
                return T(_("Text scan length: %1"), self.max_scan_length)
            end,
            keep_menu_open = true,
...
Default value: 20]]),
                    ...
                    callback = function(spin)
                        ...
                        G_reader_settings:saveSetting("japanese_text_scan_length", self.max_scan_length)
