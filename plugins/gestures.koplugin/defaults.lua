...
return {
    gesture_fm = {
        ...
        one_finger_swipe_east = nil,
        one_finger_swipe_west = nil,
        one_finger_swipe_south = nil,
        one_finger_swipe_north = nil,
        one_finger_swipe_northeast = nil,
        one_finger_swipe_northwest = nil,
        one_finger_swipe_southeast = nil,
        one_finger_swipe_southwest = nil,
    ...
    gesture_reader = {
        ...
        one_finger_swipe_south = nil,
        one_finger_swipe_north = nil,
        one_finger_swipe_northeast = {full_refresh = true,},
        one_finger_swipe_northwest = {full_refresh = true,},
        one_finger_swipe_southeast = {full_refresh = true,},
        one_finger_swipe_southwest = {full_refresh = true,},
        one_finger_swipe_left_edge_down = Device:hasFrontlight() and {decrease_frontlight = 0,} or nil,
        one_finger_swipe_left_edge_up = Device:hasFrontlight() and {increase_frontlight = 0,} or nil,
        one_finger_swipe_right_edge_down = Device:hasNaturalLight() and {decrease_frontlight_warmth = 0,} or nil,
        one_finger_swipe_right_edge_up = Device:hasNaturalLight() and {increase_frontlight_warmth = 0,} or nil,
