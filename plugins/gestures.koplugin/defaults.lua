...
return {
    gesture_fm = {
        ...
        one_finger_swipe_left_edge_down = Device:hasFrontlight() and {decrease_frontlight = true,} or nil,
        one_finger_swipe_left_edge_up = Device:hasFrontlight() and {increase_frontlight = true,} or nil,
        one_finger_swipe_right_edge_down = Device:hasNaturalLight() and {decrease_frontlight_warmth = true,} or nil,
        one_finger_swipe_right_edge_up = Device:hasNaturalLight() and {increase_frontlight_warmth = true,} or nil,
