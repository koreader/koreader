...
function Gestures:init()
    ...
    Dispatcher:init()
    self:initGesture()
    -- Overload InputContainer's stub for proper IgnoreTouchInput behavior
    InputContainer.isGestureAlwaysActive = function(ges) return self:isGestureAlwaysActive(ges) end
end
