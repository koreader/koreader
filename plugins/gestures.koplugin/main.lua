...
local gestures_list = {
    ...
    one_finger_swipe_east = "⇒",
    one_finger_swipe_west = "⇐",
    one_finger_swipe_south = "⇓",
    one_finger_swipe_north = "⇑",
...
function Gestures:setupGesture(ges)
    ...
    elseif ges == "hold_bottom_left_corner" then
        ...
        zone = zone_bottom_left_corner
        overrides = overrides_hold_corner
    elseif ges == "one_finger_swipe_east" then
        ges_type = "swipe"
        zone = zone_fullscreen
        direction = {east = true}
    elseif ges == "one_finger_swipe_west" then
        ges_type = "swipe"
        zone = zone_fullscreen
        direction = {west = true}
    elseif ges == "one_finger_swipe_south" then
        ges_type = "swipe"
        zone = zone_fullscreen
        direction = {south = true}
    elseif ges == "one_finger_swipe_north" then
        ges_type = "swipe"
        zone = zone_fullscreen
