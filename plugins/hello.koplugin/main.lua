...
-- This is a debug plugin, set one of these env variables to whatever to enale it.
if not os.getenv("KODEV_ENABLE_INCOMPATIBLE_PLUGIN") and not os.getenv("KODEV_ENABLE_HELLO_PLUGIN") then
