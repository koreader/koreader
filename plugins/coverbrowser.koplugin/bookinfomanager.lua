...
This extraction may take time and use some battery power: you may wish to keep your device plugged in.]]) , _("Cancel"), _("Continue"))
    if not go_on then
        return
    end
...
Do you want to prune cache of removed books?]]) , _("Don't prune"), _("Prune"))
