...
local _empty = {}
local function hack_cookies(cookies, header_name)
    s = ""
...
function EpubDownloadBackend:getConnexionCookies(url, credentials)
    ...
    -- local cookie_split = function (str)
    --     local sep1, sep2, lines, cookies = ",", ";", {}, {}
    --     local pattern1 = string.format("([^%s]+)", sep1)
    --     local pattern2 = string.format("([^%s]+)", sep2)
    --     string.gsub(str, pattern1, function(c) lines[#lines+1] = c end)
    --     for k,v in pairs(lines) do
    --         local fields = {}
    --         string.gsub(v, pattern2, function(c) fields[#fields+1] = c end)
    --         if string.find(fields[1], "=") then
    --             cookies[#cookies + 1] = fields[1]
    --         end
    --     end
    --     return cookies
    -- end
